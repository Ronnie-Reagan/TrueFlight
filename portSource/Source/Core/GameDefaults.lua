...
function M.create(cubeModel, q)
	...
	return {
		...
		terrainSdf = {
			...
			lod1ChunkScale = 4,
			lod2ChunkScale = 16,
			textureTilesEnabled = true,
			textureTileMaxLod = 0,
			lod0TextureResolution = 512,
			lod1TextureResolution = 256,
			lod2TextureResolution = 64,
			gameplayRadiusMeters = 512,
			midFieldRadiusMeters = 2048,
			horizonRadiusMeters = 8192,
			terrainQuality = 3.5,
			meshBuildBudget = 4,
			workerMaxInflight = 6,
